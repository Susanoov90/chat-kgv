const chatModel = require('../models/chat_v2');
...
const createChat = async (req, res, next) => {
    ...
    try {
        ...
        if(chat){
            ...
            const GpomyCode = await userModel.findOne( {_id: firstId} )

            const populateLastId = await userModel.findOne( {_id: lastId} )

            const newChat = new chatModel({
                members: [firstId, lastId],
                details_members: [GpomyCode, populateLastId]
            })
